    ...
    <div class="container has-background-img">
        ...
        <div class="media w-100 my-3">
            ...
            <div class="media-body mx-70">
                <h5 class="time-title mb-0 text-white" id="desalaikit"></h5>
                <p class="mb-0 text-truncate text-white alamatlaikit"><?= ucwords($this->setting->sebutan_kecamatan_singkat).' '.$desa['nama_kecamatan'] ?></p>
            </div>
        </div>
    </div>
